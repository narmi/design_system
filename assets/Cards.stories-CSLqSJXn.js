import{e}from"./iframe-CIl-yPrT.js";import{A as a}from"./index-BC934Xlq.js";import{C as n}from"./index-CvBKPSx9.js";import{R as r}from"./index-qBBacx5i.js";import"./preload-helper-PPVm8Dsz.js";import"./index-RvS1aOr8.js";import"./index-0rVJstEZ.js";import"./index-C8IkIAGk.js";import"./AsElement-FfstYEE1.js";const o=()=>e.createElement("div",{className:"bgColor--blueGrey",style:{padding:"2rem"}},e.createElement("div",{className:"productCard bgColor--cloudGrey rounded--all--l"},e.createElement("div",{className:"productCard-content bgColor--white rounded--top--l padding--all--s border--top border--left border--right"},e.createElement(r,null,e.createElement(r.Item,null,"Content area"),e.createElement(r.Item,{shrink:!0},e.createElement(n,{label:"",kind:"table"}))),e.createElement("div",null,"Any content can go in here.")),e.createElement(a,{renderSummary:t=>e.createElement("div",{style:{background:"transparent"}},e.createElement("div",{className:"productCard-summary bgColor--white rounded--bottom--l padding--all--s border--bottom border--left border--right"},e.createElement("span",null,t?"Close accordion":"Open accordion")))},e.createElement("div",{className:"rounded--bottom--l padding--top--l bgColor--cloudGrey padding--all--s"},"Surprise!"))));o.parameters={docs:{description:{story:`
...
\`\`\`
`}}};const h={title:"Examples/Cards",parameters:{docs:{description:{component:`
...
`}}}};o.__docgenInfo={description:"",methods:[],displayName:"ProductCard"};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`() => <div className="bgColor--blueGrey" style={{
  ...
  </div>`,...o.parameters?.docs?.source}}};const g=["ProductCard"];export{o as ProductCard,g as __namedExportsOrder,h as default};
