...
value starting with \`n\`.`,name:`value`,parent:{fileName:`design_system/src/MultiSelect/MultiSelectItem.tsx`,name:`MultiSelectItemProps`},required:!0,tags:{},type:{name:`string`}},searchValue:{defaultValue:null,declarations:[{fileName:`design_system/src/MultiSelect/MultiSelectItem.tsx`,name:`MultiSelectItemProps`}],description:`String to use for typeahead behavior`,name:`searchValue`,parent:{fileName:`design_system/src/MultiSelect/MultiSelectItem.tsx`,name:`MultiSelectItemProps`},required:!1,tags:{},type:{name:`string`}},tokenLabel:{defaultValue:null,declarations:[{fileName:`design_system/src/MultiSelect/MultiSelectItem.tsx`,name:`MultiSelectItemProps`}],description:"Text to display in the token and summary for this item.\nFalls back to `searchValue`, then `value`, when not provided.",name:`tokenLabel`,parent:{fileName:`design_system/src/MultiSelect/MultiSelectItem.tsx`,name:`MultiSelectItemProps`},required:!1,tags:{},type:{name:`string`}},children:{defaultValue:null,declarations:[{fileName:`design_system/src/MultiSelect/MultiSelectItem.tsx`,name:`MultiSelectItemProps`}],description:`JSX representation of item`,name:`children`,parent:{fileName:`design_system/src/MultiSelect/MultiSelectItem.tsx`,name:`MultiSelectItemProps`},required:!1,tags:{},type:{name:`ReactNode`}}},tags:{}}}catch{}}));function C(){return C=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)({}).hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},C.apply(null,arguments)}var w,T,E,D,O,k,A,j,M=t((()=>{w=e(n()),m(),l(),r(),h(),u(),S(),_(),a(),T=()=>{},E=e=>e?.props?e.props.searchValue||e.props.value:``,D=(e,t)=>e.map(E).includes(E(t)),O=(e,t)=>t.filter(t=>e.includes(t.props.value)),k=(e=``,t)=>t.props.searchValue||t.props.value,A=({selectedItems:e,getSelectedItemProps:t,removeSelectedItem:n,disabled:r,label:i})=>e.length===0?i:w.createElement(`div`,{className:`nds-multiselect-tokensList`},e.map((e,i)=>{let a=e.props.tokenLabel||E(e);return w.createElement(v,C({key:`${i}-${a}`,label:a,onDismiss:()=>n(e),disabled:r},t({selectedItem:e})))})),j=({name:e,label:t,children:n,selectedItems:r,onSelectedItemsChange:a=T,disabled:s=!1,fieldValue:l,errorText:u,testId:m,clearLabel:h=`Clear all`,isClearable:_=!1,summaryFormatter:v=A,getTypeaheadString:y=k})=>{let b=(0,w.useMemo)(()=>w.Children.toArray(n),[n]),x=r!==void 0,{getSelectedItemProps:S,addSelectedItem:j,removeSelectedItem:M,selectedItems:N,setSelectedItems:P}=p({initialSelectedItems:O(r||[],b),stateReducer:(e,t)=>{let{type:n,changes:r}=t;switch(n){case p.stateChangeTypes.FunctionRemoveSelectedItem:case p.stateChangeTypes.FunctionAddSelectedItem:return a((r.selectedItems??[]).map(E)),r;default:return r}}});(0,w.useEffect)(()=>{x&&P(O(r,b))},[x,r,b,P]);let{isOpen:F,getToggleButtonProps:I,getLabelProps:L,getMenuProps:R,highlightedIndex:z,getItemProps:B,inputValue:V,closeMenu:H}=f({id:e||`nds-multiselect-${t}`,items:b,itemToString:e=>y(V||``,e),stateReducer:(e,t)=>{let{changes:n,type:r}=t;switch(r){case f.stateChangeTypes.ToggleButtonKeyDownEnter:case f.stateChangeTypes.ToggleButtonKeyDownSpaceButton:case f.stateChangeTypes.ItemClick:return{...n,isOpen:!0,highlightedIndex:e.highlightedIndex};default:return n}},onStateChange:({type:e,selectedItem:t})=>{switch(e){case f.stateChangeTypes.ItemClick:case f.stateChangeTypes.ToggleButtonKeyDownEnter:case f.stateChangeTypes.ToggleButtonKeyDownSpaceButton:D(N,t)?M(t):t&&j(t);return;default:return}}}),{anchorProps:U,layerProps:W}=c({isOpen:F,setIsOpen:e=>{e||H()},polyfillScrollBug:!0}),G=(0,w.useMemo)(()=>_&&N.length>0?w.createElement(`span`,{className:`nds-multiselect-clearAll`},w.createElement(d,{kind:`plain`,size:`xs`,onClick:e=>{e.stopPropagation(),x?a([]):P([])}},h)):null,[_,N,x,a,P,h]),K=(0,w.useMemo)(()=>v({selectedItems:N,getSelectedItemProps:S,removeSelectedItem:M,disabled:s,label:t}),[N,S,M,s,t,v]);return w.createElement(`div`,{className:`nds-multiselect`,"data-testid":m},w.createElement(`input`,{type:`hidden`,name:e,id:e,value:l||N.map(E).join(`,`)}),w.createElement(`div`,C({},U,{ref:U.ref}),w.createElement(g,C({disabled:s,isOpen:F,labelText:K,endContent:G,errorText:u,labelProps:{...L(),style:_?{display:`block`,paddingRight:80}:void 0}},I()))),w.createElement(`div`,C({},W,{ref:W.ref}),w.createElement(`div`,C({className:i([`nds-multiselect-list`,`bgColor--white`,{"nds-multiselect-list--error":!!u}])},R()),F&&w.createElement(`ul`,{className:`list--reset`},b.map((e,t)=>w.createElement(`li`,C({key:`item-${t}`,className:i([`nds-multiselect-item`,`alignChild--left--center padding--x--s padding--y--xs`,{"nds-select-item--highlighted":z===t,"rounded--top":t===0,"rounded--bottom":t===b.length-1}])},B({item:e,index:t}),{role:`option`,"aria-selected":D(N,e)}),w.createElement(o,{as:`span`},w.createElement(o.Item,{as:`span`},e),D(N,e)&&w.createElement(o.Item,{as:`span`,shrink:!0},w.createElement(`span`,{className:`narmi-icon-check fontSize--xl fontWeight--bold`})))))))))},j.Item=x;try{j.displayName=`MultiSelect`,j.__docgenInfo={description:`Accessible multiple select control for giving users the ability to select
