import{l as e,o as t}from"./preload-helper-CHxnduP2.js";import{X as n}from"./iframe-BVijjhP1.js";import{n as r,t as i}from"./classcat-DVVzD5_p.js";import{n as a,t as o}from"./Row-IDFDOwWF.js";import{t as s}from"./prop-types-GrRLOqjJ.js";import{n as c,t as l}from"./useDropdownLayer-Bb6aPGBT.js";import{n as u,t as d}from"./Button-BaeqAsjB.js";import{i as f,r as p,t as m}from"./downshift.esm-B9I099F6.js";import{n as h,t as g}from"./DropdownTrigger-CGXeElnL.js";import{n as _,t as v}from"./FieldToken-KV6adcik.js";var y,b,x,S=t((()=>{y=e(n()),b=e(s()),x=({children:e})=>y.createElement(y.Fragment,null,e),x.displayName=`MultiSelect.Item`,x.propTypes={value:b.default.string.isRequired,searchValue:b.default.string,tokenLabel:b.default.string,children:b.default.oneOfType([b.default.node,b.default.arrayOf(b.default.node)])}}));function C(){return C=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)({}).hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},C.apply(null,arguments)}var w,T,E,D,O,k,A,j,M=t((()=>{w=e(n()),m(),l(),r(),h(),u(),S(),_(),a(),T=()=>{},E=e=>e?.props?e.props.searchValue||e.props.value:``,D=(e,t)=>e.map(E).includes(E(t)),O=(e,t)=>t.filter(t=>e.includes(t.props.value)),k=(e=``,t)=>t.props.searchValue||t.props.value,A=({selectedItems:e,getSelectedItemProps:t,removeSelectedItem:n,disabled:r,label:i})=>e.length===0?i:w.createElement(`div`,{className:`nds-multiselect-tokensList`},e.map((e,i)=>{let a=e.props.tokenLabel||E(e);return w.createElement(v,C({key:`${i}-${a}`,label:a,onDismiss:()=>n(e),disabled:r},t({selectedItem:e,i})))})),j=({name:e,label:t,children:n,selectedItems:r,onSelectedItemsChange:a=T,disabled:s=!1,fieldValue:l,errorText:u,testId:m,clearLabel:h=`Clear all`,isClearable:_=!1,summaryFormatter:v=A,getTypeaheadString:y=k})=>{let b=(0,w.useMemo)(()=>w.Children.toArray(n),[n]),x=r!==void 0,{getSelectedItemProps:S,addSelectedItem:j,removeSelectedItem:M,selectedItems:N,setSelectedItems:P}=p({initialSelectedItems:O(r||[],b),stateReducer:(e,t)=>{let{type:n,changes:r}=t;switch(n){case p.stateChangeTypes.FunctionRemoveSelectedItem:case p.stateChangeTypes.FunctionAddSelectedItem:return a(r.selectedItems.map(E)),r;default:return r}}});(0,w.useEffect)(()=>{x&&P(O(r,b))},[x,r,b,P]);let{isOpen:F,getToggleButtonProps:I,getLabelProps:L,getMenuProps:R,highlightedIndex:z,getItemProps:B,inputValue:V,closeMenu:H}=f({disabled:s,id:e||`nds-multiselect-${t}`,items:b,itemToString:e=>y(V||``,e),stateReducer:(e,t)=>{let{changes:n,type:r}=t;switch(r){case f.stateChangeTypes.MenuKeyDownEnter:case f.stateChangeTypes.MenuKeyDownSpaceButton:case f.stateChangeTypes.ItemClick:return{...n,isOpen:!0,highlightedIndex:e.highlightedIndex};default:return n}},onStateChange:({type:e,selectedItem:t})=>{switch(e){case f.stateChangeTypes.MenuKeyDownEnter:case f.stateChangeTypes.ItemClick:case f.stateChangeTypes.ToggleButtonKeyDownEnter:D(N,t)?M(t):t&&j(t);return;default:return}}}),{anchorProps:U,layerProps:W}=c({isOpen:F,setIsOpen:e=>{e||H()},polyfillScrollBug:!0}),G=(0,w.useMemo)(()=>_&&N.length>0?w.createElement(`span`,{className:`nds-multiselect-clearAll`},w.createElement(d,{kind:`plain`,size:`xs`,onClick:e=>{e.stopPropagation(),x?a([]):P([])}},h)):null,[_,N,x,a,P,h]),K=(0,w.useMemo)(()=>v({selectedItems:N,getSelectedItemProps:S,removeSelectedItem:M,disabled:s,label:t}),[N,S,M,s,t,v]);return w.createElement(`div`,{className:`nds-multiselect`,"data-testid":m},w.createElement(`input`,{type:`hidden`,name:e,id:e,value:l||N.map(E).join(`,`)}),w.createElement(`div`,U,w.createElement(g,C({disabled:s,isOpen:F,labelText:K,endContent:G,errorText:u,labelProps:{...L(),style:{...L().style,..._?{display:`block`,paddingRight:80}:{}}}},I()))),w.createElement(`div`,W,w.createElement(`div`,C({className:i([`nds-multiselect-list`,`bgColor--white`,{"nds-multiselect-list--error":!!u}])},R()),F&&w.createElement(`ul`,{className:`list--reset`},b.map((e,t)=>w.createElement(`li`,C({key:`item-${t}`,className:i([`nds-multiselect-item`,`alignChild--left--center padding--x--s padding--y--xs`,{"nds-select-item--highlighted":z===t,"rounded--top":t===0,"rounded--bottom":t===b.length-1}])},B({item:e,index:t}),{role:`option`,"aria-selected":D(N,e).toString()}),w.createElement(o,{as:`span`},w.createElement(o.Item,{as:`span`},e),D(N,e)&&w.createElement(o.Item,{as:`span`,shrink:!0},w.createElement(`span`,{className:`narmi-icon-check fontSize--xl fontWeight--bold`})))))))))},j.Item=x,j.__docgenInfo={description:`Accessible multiple select control for giving users the ability to select
...
- summaryFormatter: an optional function that receives the number of selected items and an array of labels,
        and returns a string summary.`,methods:[{name:`Item`,docblock:null,modifiers:[`static`],params:[{name:`{ children }: MultiSelectItemProps`,optional:!1,type:{name:`MultiSelectItemProps`,alias:`MultiSelectItemProps`}}],returns:null}],displayName:`MultiSelect`,props:{onSelectedItemsChange:{defaultValue:{value:`() => {}`,computed:!1},description:`Change callback for user actions that select or deselect items.
