...
}`,...I.parameters?.docs?.source},description:{story:"Interaction test that opens the Field.Select so Chromatic can snapshot\nthe dropdown. Options render in a dropdown layer, queried via `screen`.",...I.parameters?.docs?.description}}},L.parameters={...L.parameters,docs:{...L.parameters?.docs,source:{originalSource:`{
...
}`,...L.parameters?.docs?.source},description:{story:`Interaction test for the selection flow: open, pick an option, and
verify the trigger reflects the choice and the menu closes.`,...L.parameters?.docs?.description}}},R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`args => {
  const [value, setValue] = useState(args.value || "");
  return <FieldSelect {...args} value={value} onChange={setValue}>
      {COUNTRIES.map(({
      value,
...
}`,...H.parameters?.docs?.source}}},U=[`Overview`,`Opens`,`SelectsOption`,`WithValue`,`WithErrors`,`Disabled`,`WithHelperText`,`SideBySideWithText`]}))();export{B as Disabled,I as Opens,F as Overview,L as SelectsOption,H as SideBySideWithText,z as WithErrors,V as WithHelperText,R as WithValue,U as __namedExportsOrder,M as default};