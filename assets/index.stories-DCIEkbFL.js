import{r as l,e}from"./iframe-CJ4Vn6T5.js";import"./useFetch-B7n56vkK.js";import{F as k}from"./Combination-DFbrHBUh.js";import{u as C}from"./index-BCy2kL8f.js";import{B as f}from"./index-C2VWkS0P.js";import{C as b}from"./index-DwwA52Io.js";import"./preload-helper-PPVm8Dsz.js";import"./extends-DDykod_l.js";import"./tslib.es6-rrx6G-_s.js";import"./inheritsLoose-CWawPfk8.js";import"./raf-schd.esm-CmoV45_-.js";import"./index-RvS1aOr8.js";import"./AsElement-BqhcWvKT.js";import"./index-BUQ9GW2c.js";import"./index-DoR8nCwo.js";import"./index-Chjiymov.js";import"./index-Bk-UgLnA.js";import"./index-CLIvXBGR.js";function D(t,n,r,a){const o=l.useRef(n);x(()=>{o.current=n},[n]),l.useEffect(()=>{var s;const d=(s=void 0)!==null&&s!==void 0?s:window;if(!(d&&d.addEventListener))return;const i=c=>o.current(c);return d.addEventListener(t,i,a),()=>{d.removeEventListener(t,i,a)}},[t,r,a])}const x=typeof window<"u"?l.useLayoutEffect:l.useEffect;function I(t,n,r="mousedown"){D(r,a=>{const o=t?.current;!o||o.contains(a.target)||n(a)})}const u=({isOpen:t=!1,onUserDismiss:n=()=>{},renderHeader:r,renderFooter:a,isPortalled:o=!1,children:s,testId:d,trigger:i})=>{const{anchorProps:c,layerProps:y}=C({isOpen:t,setIsOpen:n,matchWidth:!1,isPortalled:o,ariaPopupType:"dialog"});I(y.ref,()=>{n()});const v=O=>{O.key==="Escape"&&n()};if(l.useEffect(()=>{if(t)return document.addEventListener("keydown",v),()=>{document.removeEventListener("keydown",v)}},[t,n]),!t&&!i)return null;const E=i?e.cloneElement(i,{ref:c.ref,style:{...i.props.style,...c.style},"aria-haspopup":c["aria-haspopup"],"aria-expanded":c["aria-expanded"]}):null;return e.createElement(e.Fragment,null,E,t&&e.createElement("div",{ref:y.ref,className:"nds-anchoredDialog","data-testid":d,style:y.style},e.createElement(k,{returnFocus:!0,autoFocus:!0,className:"nds-anchoredDialog-inner"},r&&e.createElement("div",{className:"nds-anchoredDialog-header border--bottom"},r()),e.createElement("div",{className:"nds-anchoredDialog-content"},s),a&&e.createElement("div",{className:"nds-anchoredDialog-footer border--top"},a()))))};try{u.displayName="AnchoredDialog",u.__docgenInfo={description:`A dialog component that can anchor to a trigger element.
