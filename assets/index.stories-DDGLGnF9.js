import{l as e,o as t}from"./preload-helper-CHxnduP2.js";import{X as n}from"./iframe-BtK-a5gI.js";import{n as r,t as i}from"./classcat-DVVzD5_p.js";import{r as a,t as o}from"./Select-DpBKq_NU.js";var s,c,l=t((()=>{s=e(n()),r(),c=({name:e,lastFour:t,isInline:n})=>s.createElement(`span`,{className:i([`nds-truncatedAccount`,{"nds-truncatedAccount--inline":n}]),title:t?`${e} - ${t}`:e},s.createElement(`span`,{className:`whiteSpace--truncate`},e),t&&s.createElement(`span`,{role:`img`,className:`padding--x--xxs`},`-`),t&&s.createElement(`span`,{className:`whiteSpace--singleLine`},t));try{c.displayName=`TruncatedAccount`,c.__docgenInfo={description:`Auto-truncated display of account name and account last four digits.
