...
some Chips (e.g. surfacing an error message) carry content a user may want to copy.`,name:`isLabelSelectable`,parent:{fileName:`design_system/src/Chip/index.tsx`,name:`ChipProps`},required:!1,tags:{},type:{name:`boolean`}}},tags:{}}}catch{}}));function h(){return h=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)({}).hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},h.apply(null,arguments)}var g,_,v,y,b,x,S,C,w,T,E,D,O,k;t((()=>{g=e(n()),s(),m(),_=e=>g.createElement(p,e),v=_.bind({}),v.args={label:`Label`,onDismiss:()=>{},count:5},y=()=>g.createElement(g.Fragment,null,g.createElement(`p`,null,`When an `,g.createElement(`code`,null,`onDismiss`),` handler is passed, a close icon will render as a button at the end of the Chip`),g.createElement(p,{label:`Dismissable`,onDismiss:()=>{}})),b=()=>g.createElement(g.Fragment,null,g.createElement(`p`,null,`When an `,g.createElement(`code`,null,`onClick`),` handler is passed, the entire chip becomes clickable.`),g.createElement(p,{label:`Clickable Chip`,onClick:()=>{}})),x=()=>g.createElement(g.Fragment,null,g.createElement(`p`,null,`When the `,g.createElement(`code`,null,`hasBorder`)," prop is set to true, a border will be rendered based on the `kind` of the Chip."),g.createElement(p,{kind:`warn`,label:`Bordered`,hasBorder:!0})),S=()=>g.createElement(g.Fragment,null,g.createElement(`p`,null,`By default a Chip's label is not selectable, since Chips are typically short filter/status tags. When the`,` `,g.createElement(`code`,null,`isLabelSelectable`),` prop is set to true, the label text can be selected/copied — useful when a Chip surfaces content like an error message.`),g.createElement(p,{kind:`error`,label:`Selectable error text`,isLabelSelectable:!0})),C=()=>g.createElement(g.Fragment,null,g.createElement(`p`,null,`The `,g.createElement(`code`,null,`radiusSize`),` prop controls the border radius of the Chip. Accepts `,g.createElement(`code`,null,`"s"`),`, `,g.createElement(`code`,null,`"m"`),` (default), or `,g.createElement(`code`,null,`"l"`),`.`),g.createElement(c,{alignItems:`center`,gapSize:`s`},[`s`,`m`,`l`].map(e=>g.createElement(c.Item,{key:e,shrink:!0},g.createElement(p,{label:`radiusSize "${e}"`,radiusSize:e}))))),w=()=>g.createElement(g.Fragment,null,g.createElement(`p`,null,`Chip accepts both a `,g.createElement(`code`,null,`startIcon`),` and `,g.createElement(`code`,null,`endIcon`),` prop.`),g.createElement(p,{kind:`info`,label:`Trigger Dropdown`,onClick:()=>{},endIcon:`chevron-down`})),T=()=>g.createElement(g.Fragment,null,g.createElement(`p`,null,`Chip accepts both a `,g.createElement(`code`,null,`startIcon`),` and `,g.createElement(`code`,null,`endIcon`),` prop.`),g.createElement(p,{kind:`info`,isLabelVisible:!1,onClick:()=>{},endIcon:`zap`})),E=[`anchor`,`wifi`,`sun`,`phone-off`,`moon`,`music`],D=()=>g.createElement(`ul`,{className:`list--reset`},f.map((e,t)=>g.createElement(`li`,{key:`${e}-${t}`,className:`margin--bottom`},g.createElement(c,{alignItems:`center`,gapSize:`xs`},g.createElement(c.Item,{shrink:!0},g.createElement(p,{kind:e,label:`Label`})),g.createElement(c.Item,{shrink:!0},g.createElement(p,{kind:e,label:`Label`,startIcon:E[t]})),g.createElement(c.Item,{shrink:!0},g.createElement(p,{kind:e,label:`Label`,count:`5`})),g.createElement(c.Item,{shrink:!0},g.createElement(p,h({kind:e},v.args))),g.createElement(c.Item,{shrink:!0},g.createElement(`div`,{style:{textTransform:`capitalize`},className:`padding--right--xl`},e)))))),O={title:`Components/Chip`,component:p},y.__docgenInfo={description:``,methods:[],displayName:`WithDismiss`},b.__docgenInfo={description:``,methods:[],displayName:`AsButton`},x.__docgenInfo={description:``,methods:[],displayName:`WithBorder`},S.__docgenInfo={description:``,methods:[],displayName:`SelectableLabel`},C.__docgenInfo={description:``,methods:[],displayName:`RadiusSize`},w.__docgenInfo={description:``,methods:[],displayName:`CustomIcon`},T.__docgenInfo={description:``,methods:[],displayName:`IconOnly`},D.__docgenInfo={description:``,methods:[],displayName:`Kinds`},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`args => <Chip {...args} />`,...v.parameters?.docs?.source}}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`() => <>
    ...
    <Row alignItems="center" gapSize="s">
      {["s", "m", "l"].map(size => <Row.Item key={size} shrink>
  ...
  </>`,...T.parameters?.docs?.source}}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`() => <ul className="list--reset">
  ...
  </ul>`,...D.parameters?.docs?.source}}},k=[`Overview`,`WithDismiss`,`AsButton`,`WithBorder`,`SelectableLabel`,`RadiusSize`,`CustomIcon`,`IconOnly`,`Kinds`]}))();export{b as AsButton,w as CustomIcon,T as IconOnly,D as Kinds,v as Overview,C as RadiusSize,S as SelectableLabel,x as WithBorder,y as WithDismiss,k as __namedExportsOrder,O as default};