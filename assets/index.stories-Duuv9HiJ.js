import{e,r as i}from"./iframe-B5KCP8xM.js";import{P as d}from"./index-Dp-Puaae.js";import{P as k}from"./index-C_lk_oZa.js";import{c as w}from"./index-RvS1aOr8.js";import{u as U}from"./downshift.esm-scJ14p-f.js";import{T as x}from"./index-XY-fjSlw.js";import{R as V}from"./index-ClBTR75t.js";import{B as S}from"./index-jG6wBWCr.js";import"./preload-helper-PPVm8Dsz.js";import"./dom-xL8L4s4L.js";import"./index-Brke84_W.js";import"./index-Cxn3yf4i.js";import"./Combination-CiXXog5I.js";import"./extends-DDykod_l.js";import"./tslib.es6-rrx6G-_s.js";import"./inheritsLoose-CWawPfk8.js";import"./index-DnzVWoUu.js";import"./index-CytHhSGW.js";import"./selection-CAkQuomx.js";import"./AsElement-C1zh-FBb.js";import"./index-Cc7HWQpE.js";const N=({children:a,value:n})=>e.createElement(e.Fragment,null,a||n);N.displayName="Combobox.Item";N.propTypes={value:d.string.isRequired,searchValue:d.string.isRequired,children:d.oneOfType([d.node,d.arrayOf(d.node)])};try{Combobox.Item.displayName="Combobox.Item",Combobox.Item.__docgenInfo={description:"",displayName:"Combobox.Item",props:{value:{defaultValue:null,description:"",name:"value",required:!0,type:{name:"any"}}}}}catch{}function A(){return A=Object.assign?Object.assign.bind():function(a){for(var n=1;n<arguments.length;n++){var l=arguments[n];for(var o in l)({}).hasOwnProperty.call(l,o)&&(a[o]=l[o])}return a},A.apply(null,arguments)}const b=a=>a.props.searchValue||a.props.value||"",P=(a,n)=>a.filter(l=>b(l).toLowerCase().includes(n.toLowerCase())),_=({label:a,items:n,selectedItem:l,onChange:o=()=>{},onInputChange:g=()=>{},footerContent:u})=>{const[s,m]=i.useState(n);i.useEffect(()=>{m(n)},[m,n]);const{selectedItem:h,highlightedIndex:E,getMenuProps:y,getInputProps:M,getItemProps:C}=U({items:s,initialSelectedItem:l,initialInputValue:"",onInputValueChange({inputValue:r}){m(r?.length>0?P(n,r):n),g(r)},onSelectedItemChange({selectedItem:r}){r&&o(r)},itemToString(r){return b(r)}});return e.createElement("div",{className:w(["nds-autocompleteModal-autocomplete","rounded--all"])},e.createElement("div",{className:"nds-autocompleteModal-input"},e.createElement(x,A({label:a},M()))),e.createElement("ul",A({className:"nds-autocompleteModal-menu list--reset"},y()),s.length===0&&!h&&e.createElement("li",{className:"nds-autocompleteModal-item padding--x--s padding--y--xs"},"No results found"),s.map((r,c)=>e.createElement("li",A({className:w(["nds-autocompleteModal-item","padding--x--s padding--y--xs",{"nds-autocompleteModal-item--highlighted":E===c}]),key:`${r?.props.value}-${c}`},C({item:r,index:c})),e.createElement(V,null,e.createElement(V.Item,null,r),h&&h.props.value===r.props.value&&e.createElement(V.Item,{as:"span",shrink:!0},e.createElement("span",{className:"narmi-icon-check fontSize--xl fontWeight--bold"})))))),u&&e.createElement("div",{className:"nds-autocompleteModal-footer padding--all--s border--top"},u))};try{b.displayName="itemToString",b.__docgenInfo={description:"",displayName:"itemToString",props:{}}}catch{}try{_.displayName="AutoComplete",_.__docgenInfo={description:`A simplified Combobox component that renders in a Popup.
...
}`,...p.parameters?.docs?.source}}};const ae=["Overview","WithSearchValue","WithAction","TriggerRenderProp"];export{v as Overview,p as TriggerRenderProp,f as WithAction,I as WithSearchValue,ae as __namedExportsOrder,te as default};
