import{r as h,e}from"./iframe-C2GiQxmI.js";import{c as b}from"./index-RvS1aOr8.js";import"./preload-helper-PPVm8Dsz.js";const F=5,k=(t,l)=>[...Array(l-t+1)].map((s,o)=>t+o),_=(t,l,s)=>{if(t<=s+1)return k(1,t);const o=l>Math.ceil(s/2),r=l<=t-Math.floor(s/2),c=[o,r].filter(Boolean).length===2?s-2:s,g=Math.floor(c/2);let i=l-g,d=i+c-1;return i<1?(i=1,d=c):d>t&&(d=t,i=t-c+1),k(i,d)},T=({totalPages:t,selectedPageNumber:l=1,windowSize:s=F})=>{const o=Math.max(1,t),r=Math.max(1,Math.min(l,o)),n=h.useMemo(()=>_(o,r,s),[o,r,s]);return{visiblePages:n,selectedPage:r,selectedIndex:n.indexOf(r),showFirstPage:n[0]>1,showLastPage:n[n.length-1]<o,showPrev:r>1,showNext:r<o}},M=()=>{},P=({onPageChange:t=M,totalPages:l=1,defaultSelectedPage:s=1,selectedPage:o,testId:r})=>{const n=o!==void 0,[c,g]=h.useState(s),i=n?o:c,{visiblePages:d,selectedIndex:v,showPrev:E,showNext:y,showFirstPage:C,showLastPage:x}=T({totalPages:l,selectedPageNumber:i}),p=({target:a})=>{const m=parseInt(a.dataset.page,10);n||g(m),t(m)},I=()=>{const a=i-1;n||g(a),t(a)},N=()=>{const a=i+1;n||g(a),t(a)},w=e.createElement("div",{className:"nds-typography nds-pagination","data-testid":r},e.createElement("nav",{"aria-label":"pagination"},e.createElement("ul",null,e.createElement("li",null,e.createElement("span",{role:"button",tabIndex:0,"aria-disabled":!E,"aria-label":"Previous page",onClick:I,onKeyUp:({key:a})=>{a==="Enter"&&I()},className:b(["nds-pagination-page","padding--none",{"nds-pagination-page--disabled":!E}])},e.createElement("i",{role:"img",className:"narmi-icon-chevron-left fontSize--xl"}))),C&&e.createElement("li",null,e.createElement("span",{role:"button",tabIndex:0,"aria-label":"First page",onClick:p,onKeyUp:a=>{a.key==="Enter"&&p(a)},"data-page":1,className:"nds-pagination-page"},"1")),C&&e.createElement("li",null,e.createElement("div",{className:"nds-pagination-ellipsis"},"…")),d.map((a,m)=>e.createElement("li",{key:`page-${a}`},e.createElement("span",{role:"button",tabIndex:0,className:b(["nds-pagination-page",{"nds-pagination-page--selected":m===v}]),"data-page":a,onClick:p,onKeyUp:S=>{S.key==="Enter"&&p(S)},"aria-label":`Page ${a}`,"aria-current":m===v&&"page"},a.toString()))),x&&e.createElement("li",null,e.createElement("div",{className:"nds-pagination-ellipsis"},"…")),x&&e.createElement("li",null,e.createElement("span",{role:"button",tabIndex:0,"aria-label":"Last page",onClick:p,onKeyUp:a=>{a.key==="Enter"&&p(a)},"data-page":l,className:"nds-pagination-page"},l.toString())),e.createElement("li",null,e.createElement("span",{role:"button",tabIndex:0,"aria-disabled":!y,"aria-label":"Next page",onClick:N,onKeyUp:({key:a})=>{a==="Enter"&&N()},className:b(["nds-pagination-page","padding--none",{"nds-pagination-page--disabled":!y}])},e.createElement("i",{role:"img",className:"narmi-icon-chevron-right fontSize--xl"}))))));return l>1?w:e.createElement(e.Fragment,null)};P.__docgenInfo={description:`Component that allows users to navigate between pages of information.
