import{e,r as g}from"./iframe-Y1x1tuQU.js";import{R as c}from"./index-DBAl-tlK.js";import{P as o}from"./index-BDnsBicE.js";import{c as b}from"./index-RvS1aOr8.js";import"./preload-helper-PPVm8Dsz.js";import"./AsElement-rDk3pDkz.js";const f=()=>{},r=({kind:s="subdued",onDismiss:t=f,dismissible:a,label:n,testId:p})=>e.createElement("div",{className:b(["nds-typography","nds-tag",`nds-tag--${s}`]),"data-testid":p},e.createElement("div",{className:"whiteSpace--truncate"},n),(a||s==="dismissible")&&e.createElement("div",{className:"narmi-icon-x margin--left--xs",role:"button",tabIndex:0,onClick:t,onKeyUp:({key:u})=>{(u==="Enter"||u==" ")&&t()}}));r.propTypes={kind:o.oneOf(["subdued","subdued-secondary","dismissible","outline","success","warn","error"]),onDismiss:o.func,dismissible:o.bool,label:o.string,testId:o.string};r.__docgenInfo={description:`A rounded rectangle inline label.
