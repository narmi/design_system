import{l as e,o as t}from"./preload-helper-CHxnduP2.js";import{X as n}from"./iframe-DkJKnIFf.js";import{i as r,n as i,r as a,t as o}from"./Row-VVsO9Eay.js";import{n as s,t as c}from"./Button-BmdEgd1X.js";var l,u,d,f,p,m,h,g,_;t((()=>{l=e(n()),s(),i(),r(),u=e=>l.createElement(`div`,{className:`nds-typography`},l.createElement(o,e)),d=u.bind({}),d.args={children:[l.createElement(o.Item,{shrink:!0},l.createElement(`img`,{alt:`demo`,src:`https://via.placeholder.com/60`})),l.createElement(o.Item,null,`The image row item is set to `,l.createElement(`code`,null,`shrink`)," to content width. This item grows to fill remaining space. Adjust the `gapSize` prop on `Row` to adjust the gutters between items.")]},f=()=>l.createElement(l.Fragment,null,l.createElement(`style`,{dangerouslySetInnerHTML:{__html:`
