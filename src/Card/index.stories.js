...
export const Form = () => {
  ...
  return (
    <div className="nds-typography" style={{ maxWidth: "50em" }}>
      <h4 className="nds-sans" style={{ marginBottom: "0" }}>
        Access Level
      </h4>
      ...
      <div style={{ textAlign: "right", marginTop: "1em" }}>
        ...
        <Button
          onClick={() =>
            alert(
              `The current value of the form input is ${hiddenInput.current.value}`
            )
          }
        >
          Submit
