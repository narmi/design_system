...
const Square = styled.div`
  ...
  background-color: ${(props) =>
    props.color ? `var(${props.color})` : "var(--nds-narmi-purple)"};
  border-radius: 4px;
...
const Squares = (props) => {
  ...
  return Object.entries(byCategory).map(([cat, colors]) => (
    <StyledRow>
      <Typography h1 style={{ marginBottom: "8px" }}>
        {cat}
      </Typography>
      <StyledRow>
        {colors.map((c) => (
...
const DefaultArgs = {
  colors: [
    ...
    {
      css: "--nds-secondary-color",
      title: "Secondary Color",
      category: "Brand",
    },
    { css: "--nds-tertiary-color", title: "Tertiary Color", category: "Brand" },
    {
      css: "--nds-primary-color-light",
      title: "Subdued 20%",
      category: "Subdued",
    },
    {
      css: "--nds-primary-color-lighter",
      title: "Subdued 10%",
      category: "Subdued",
    },
    {
      css: "--nds-primary-color-lightest",
      title: "Subdued 5%",
      category: "Subdued",
    },
    { css: "--nds-messaging-green", title: "Green", category: "Messaging" },
    {
      css: "--nds-messaging-green-light",
      title: "Light Green",
      category: "Messaging",
    },
    { css: "--nds-messaging-yellow", title: "Yellow", category: "Messaging" },
    {
      css: "--nds-messaging-yellow-light",
      title: "Light Yellow",
      category: "Messaging",
    },
    { css: "--nds-messaging-red", title: "Red", category: "Messaging" },
    {
      css: "--nds-messaging-red-light",
      title: "Light Red",
      category: "Messaging",
    },
    {
      css: "--nds-background-bluegrey",
      title: "Blue Grey",
      category: "Backgrounds",
    },
    {
      css: "--nds-background-neutralgrey",
      title: "Neutral Grey",
      category: "Backgrounds",
    },
    {
      css: "--nds-background-smokegrey",
      title: "Smoke Grey",
      category: "Backgrounds",
    },
    { css: "--nds-grey-text", title: "Grey", category: "Elements" },
    {
      css: "--nds-grey-placeholder",
      title: "Light Grey",
      category: "Elements",
    },
    {
      css: "--nds-grey-disabled",
      title: "Lightest Grey",
      category: "Elements",
    },
  ],
