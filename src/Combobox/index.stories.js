...
export const MobileOverflowRegression = () => (
  // Replicates AO .animated-light-bg
  <div
    style={{
      minHeight: "100vh",
      width: "100vw",
          ...
          <div style={{ width: "100%" }}>
            ...
            >
              ...
              >
                ...
                >
                  {/* Question wrapper (div.question) */}
                  <div>
                    {/* ContextForm.Field wrapper */}
                    <div className="context-form-field">
                      <Combobox label="Select answer">
                        ...
                        >
                          Yes, I am a current member of this financial
                          institution
                        </Combobox.Item>
                        <Combobox.Item
                        ...
                        >
                          No, I have never been a member of this financial
                          institution and would like to apply
                        </Combobox.Item>
                        <Combobox.Item
...
MobileOverflowRegression.parameters = {
  viewport: { defaultViewport: "mobile1" },
  layout: "fullscreen",
  docs: {
    description: {
      story:
        "Regression test for mobile horizontal overflow. Replicates the AO consumer eligibility layout: animated-light-bg (100vw, overflow hidden, 1000px blur blobs) > app-background-layout (flex column, 12px padding) > top-section (flex column) > content-container (align-self: center) > contentCard (width 100%) > content-section (negative margins) > ResponsiveFlex (flex column) > ContextForm.Field > Combobox. Select the long-label item and verify no horizontal scroll. Must be tested on a real mobile device — open in its own tab.",
    },
  },
};
